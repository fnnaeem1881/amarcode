...
export class AgentSocket {
  ...
  chat(payload: { sessionId?: string; root: string; task: string; override?: { providerId: string; model: string }; previewUrl?: string; lite?: boolean; images?: string[]; mode?: "home" | "code" }, handlers: AgentStreamHandlers): void {
